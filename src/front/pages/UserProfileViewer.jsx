...
function UserProfileViewer() {
    ...
    const userIdToConsult = parseInt(userId);
    ...
    async function fetchUserProfileById(jwtToken, userIdToConsult) {
        ...
        console.log(userIdToConsult, "línea 28");
        console.log(jwtToken, "línea 29");



        try {
            const response = await fetch(import.meta.env.VITE_BACKEND_URL + `/api/users/${userIdToConsult}`, {
                method: 'GET',
                headers: {
    ...
    useEffect(() => {
        const loadUserProfile = async () => {
            ...
            console.log("JWT Token desde localStorage:", jwtToken);
