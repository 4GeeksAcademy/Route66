...
const UserProfilesApp = () => {
  ...
  return (
    <>
      {userRole === 'broker' && <BrokerProfileCard />}
      {userRole === 'carrier' && <CarrierProfileCard />}
      {!userRole && <Typography variant="h6" sx={{ textAlign: 'center', mt: 4 }}>Por favor, inicia sesión para ver tu perfil.</Typography>}
    </>
  );
};
