    ...
    async function registerCarrier(data) {
        ...
        try {
            ...
            try {
                ...
                result = { msg: "Error inesperado del servidor (respuesta no JSON)" };
            }
            ...
            if (res.ok) {
                ...
                setAlerta({ mensaje: `Error al registrar: ${result.msg || res.statusText}`, tipo: "danger" });
                return null;
            }
        } catch (err) {
    ...
    async function registerBroker(data) {
        ...
        try {
            ...
            if (res.ok) { 
                ...
                setAlerta({ mensaje: `Error al registrar broker: ${result.msg || res.statusText}`, tipo: "danger" });
                return null;
            }
        } catch (err) {
            console.error("Error de red o servidor:", err); 
